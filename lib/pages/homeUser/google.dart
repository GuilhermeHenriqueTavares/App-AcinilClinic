  ...
  void changeBrightness() {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Bem-Vindo '  , style: TextStyle(fontSize: 16.9, color: Colors.white), ),
      ),
      body: Builder(
      ...
      drawer: Drawer(
        child: Column(
          ...
          UserAccountsDrawerHeader(
              accountName: Text(FBApi.firebaseUser.displayName, style: TextStyle(fontSize: 18),),
              accountEmail: Text(FBApi.firebaseUser.email ,style: TextStyle(fontSize: 15),),
              currentAccountPicture: CircleAvatar(backgroundImage: NetworkImage(FBApi.firebaseUser.photoUrl),),
